...
public class Expression
{
    ...
    private HashMap<AbstractVariable, Double> _terms;

    public Expression(AbstractVariable clv, double value, double constant)
    {
        _constant = constant;
        _terms = new HashMap<AbstractVariable, Double>();
        if (clv != null)
        {
    ...
    protected Expression(double constant, HashMap<AbstractVariable, Double> terms)
    {
        _constant = constant;
        _terms = new HashMap<AbstractVariable, Double>();
    ...
    public final HashMap<AbstractVariable, Double> terms()
    {
        return _terms;
    }
